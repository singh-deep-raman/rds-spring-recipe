package com.raman.recipe.bootstrap;

import com.raman.recipe.domain.*;
...
/**
 * 1. This class will load data into DB, we could have used SQL but it is more convenient to save using POJOs
...
public class DataBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Recipe getGuacaRecipe() {
        ...
        /** Get Unit Of Measurement from DB, we assume every UOM is present, so not handling negative scenarios */
        ...
        /** removing ingredient field from initializing, because it will be taken care by recipe addIngredient() method */
